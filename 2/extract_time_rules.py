...
INPUT_FILE = r"D:\Desktop\bool\raw_rules_time.jsonl"
OUTPUT_FILE = r"D:\Desktop\bool\extract_time_results.jsonl"
ERROR_FILE = r"D:\Desktop\bool\extract_time_errors.jsonl"
...
当前阶段处理“布尔逻辑 + 时间约束逻辑”的规则抽取，采用“三阶段抽取”方式：
...
如果一个事件既有顺序关系又有时间窗口约束，可以同时输出，例如：
- SEQUENCE(E1, E2)
- WITHIN(E2, 30天)
...
3. temporalLogic
是数组，内部每个元素是一个时间逻辑表达式，例如：
[
  "SEQUENCE(E1, E2)",
  "WITHIN(E2, 30天)"
]

如果规则中没有明确时间逻辑，则输出空数组：
[]

4. output
是规则最终输出的风险结论，尽量保留原文表述，但不保留“判定为”这类动作词，只保留风险结论本体。
